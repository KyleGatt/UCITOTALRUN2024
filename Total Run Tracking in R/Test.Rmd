...
Today<-as.Date("2024-08-02",format("%Y-%m-%d"))
Yesterday<-Today-1
...
::: {align="left"}
**Table 1.-** Management tiers for the late-run stock Kenai River sockeye salmon.
:::
...
::: {align="left"}
**Table 2.-** Total run projections by stock.
:::
...
::: {align="left"}
**Table 3.-** Cumulative total run estimates to date for primary Upper Cook Inlet sockeye salmon stocks.
:::
...
::: {align="left"}
**Table 4.-** Age composition of returns to the Kenai and Kasilof Rivers in 2024 relative to preseason forecasts.
:::
